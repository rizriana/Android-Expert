                ...
                .getRoute(object : retrofit2.Callback<DirectionsResponse> {
                    override fun onResponse(call: Call<DirectionsResponse>, response: Response<DirectionsResponse>) {
                        if (response.body() == null) {
                            Toast.makeText(this@MainActivity, "No route found, ake sure you set the right user and access token.", Toast.LENGTH_SHORT).show()
                            return
        ...
        if (PermissionsManager.areLocationPermissionsGranted(this)) {
            ...
            permissionsManager = PermissionsManager(object : PermissionsListener {
                override fun onExplanationNeeded(permissionsToExplain: MutableList<String>?) {
                    Toast.makeText(this@MainActivity, "Anda harus mengizinkan location untuk menggunakan aplikasi ini", Toast.LENGTH_SHORT).show()
                }
